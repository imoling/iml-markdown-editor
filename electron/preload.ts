...
contextBridge.exposeInMainWorld('api', {
  ...
  ai: {
    ...
    chat: (messages: any[], onStream: (chunk: string) => void, requestId: string, maxTokens?: number, temperature?: number, opts?: { quiet?: boolean }) => {
      ...
      return new Promise((resolve, reject) => {
        ...
        ipcRenderer.send('ai:chat', { messages, requestId, maxTokens, temperature, quiet: !!opts?.quiet });
      });
    },
