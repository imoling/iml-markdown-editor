    ...
    pages: [
      {
        ...
        bullets: ['两个模型可选：Z-Image Turbo（八步出图，快）或 Qwen-Image 2.1（细）', '出图的几分钟里正文占着位，随时能取消', '几个本机模型按内存灵活调度，不会一股脑全起来把机器压垮'],
        image: 'v265-image',
      },
      {
      ...
      {
        key: 'resources', kicker: '本机智能', title: '单机多模型，按内存灵活调度', hint: '智能 → 本机资源',
